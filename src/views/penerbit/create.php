...
<div class="container-fluid mt-5">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <h2><i class="fas fa-plus-circle"></i> Tambah Penerbit</h2>
            <hr>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form action="index.php?page=penerbit/store" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_penerbit" name="nama_penerbit" 
                                   placeholder="Masukkan nama penerbit" maxlength="50" required>
                        </div>
                        <div class="mb-3">
                            <label for="kota" class="form-label">Kota <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="kota" name="kota" 
                                   placeholder="Contoh: Jakarta, Bandung" maxlength="30" required>
                        </div>
