        ...
        <div class="col-lg-10 offset-lg-1">
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0"><i class="fas fa-book-medical me-2"></i> Tambah Data Buku Baru</h4>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="isbn" name="isbn" required 
                                           ...
                                           value="<?= htmlspecialchars($post_data['isbn'] ?? '') ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="judul" name="judul" required 
                                           ...
                                           value="<?= htmlspecialchars($post_data['judul'] ?? '') ?>">
                                    ...
                                    <select class="form-select" id="id_penulis" name="id_penulis" required>
                                        ...
                                        <?php foreach ($penulis as $p): ?>
                                            <option value="<?= $p['id_penulis'] ?>" 
                                                <?= ($post_data['id_penulis'] ?? '') == $p['id_penulis'] ? 'selected' : '' ?>>
                                    ...
                                    <select class="form-select" id="id_penerbit" name="id_penerbit" required>
                                        ...
                                        <?php foreach ($penerbit as $p): ?>
                                            <option value="<?= $p['id_penerbit'] ?>" 
                                                <?= ($post_data['id_penerbit'] ?? '') == $p['id_penerbit'] ? 'selected' : '' ?>>
                                    ...
                                    <select class="form-select" id="id_kategori" name="id_kategori" required>
                                        ...
                                        <?php foreach ($kategori as $k): ?>
                                            <option value="<?= $k['id_kategori'] ?>"
                                                <?= ($post_data['id_kategori'] ?? '') == $k['id_kategori'] ? 'selected' : '' ?>>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="tahun_terbit" name="tahun_terbit" required 
                                           ...
                                           value="<?= htmlspecialchars($post_data['tahun_terbit'] ?? '') ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="jumlah" name="jumlah" required 
                                           ...
                                           value="<?= htmlspecialchars($post_data['jumlah'] ?? 1) ?>">
                                    <div class="invalid-feedback">Jumlah wajib diisi (minimal 1).</div>
                                </div>
                                
                                <!-- Sampul Buku -->
                                <div class="mb-3">
                                    <label for="foto_sampul" class="form-label">Sampul Buku (Opsional):</label>
                                    <input type="file" class="form-control" id="foto_sampul" name="foto_sampul" accept="image/*">
                                    <div class="form-text">Maksimal 5MB. Format: JPG, JPEG, PNG, GIF.</div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="sinopsis" name="sinopsis" rows="5" 
                                              placeholder="Tulis sinopsis singkat buku ini..."><?= htmlspecialchars($post_data['sinopsis'] ?? '') ?></textarea>
